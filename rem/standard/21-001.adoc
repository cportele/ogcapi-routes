:Title: OGC Route Exchange Model
:titletext: Route Exchange Model
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/is/rem/1.0
|Internal reference number of this OGC(R) document:    21-001
